...
The first topic that I've chosen to export it from my mind is **Regex**. While **Regex** is handy and you can pick it up quickly, it causes tons of frustration. You can use it everywhere when you want to search for  a specific part of your file, no matter if it's in a **Sublime Text Editor** or a **grep** command in Linux.
